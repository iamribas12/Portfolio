import { Code, Database, Globe, Smartphone, GraduationCap, Calendar, MapPin, Award } from "lucide-react";
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-20 animate-fade-in">
          ...
          <div className="space-y-8">
            {education.map((edu, index) => (
              <Card key={index} className="overflow-hidden hover-lift shadow-custom-lg animate-slide-up" style={{ animationDelay: `${index * 0.2}s` }}>
        ...
        <div className="mb-16 animate-fade-in">
          <div className="text-center mb-8">
            ...
            <p className="text-muted-foreground">Professional development and recognition</p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {achievements.map((achievement, index) => (
              <Card key={index} className="p-4 hover-lift bg-card border shadow-custom-sm">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground">Certified {achievement.year}</p>
                    </div>
                  </div>
        ...
        <div className="text-center animate-fade-in">
          <div className="bg-gradient-card rounded-2xl p-8 shadow-custom-lg">
            ...
            <p className="text-muted-foreground leading-relaxed max-w-3xl mx-auto">
              ...
              clean code practices, and creating solutions that truly serve users' needs. My passion 
              for technology drives me to stay updated with the latest trends and best practices in 
